...
class PrivateChatManager(
    ...
    // Read receipts disabled - no unread tracking needed
    
    // MARK: - Private Chat Lifecycle
    
    fun startPrivateChat(peerID: String, meshService: com.wichat.android.wifi.WifiMeshService): Boolean {
    ...
    fun blockPeer(peerID: String, meshService: com.wichat.android.wifi.WifiMeshService): Boolean {
        val fingerprint = fingerprintManager.getFingerprintForPeer(peerID)
        if (fingerprint != null) {
    ...
    fun unblockPeer(peerID: String, meshService: com.wichat.android.wifi.WifiMeshService): Boolean {
        val fingerprint = fingerprintManager.getFingerprintForPeer(peerID)
    ...
    fun blockPeerByNickname(targetName: String, meshService: com.wichat.android.wifi.WifiMeshService): Boolean {
    ...
    fun unblockPeerByNickname(targetName: String, meshService: com.wichat.android.wifi.WifiMeshService): Boolean {
        val peerID = getPeerIDForNickname(targetName, meshService)
    ...
    fun cleanupDisconnectedPeer(peerID: String) {
        ...
        // Read receipts disabled - no cleanup needed
        Log.d(TAG, "Cleaned up for disconnected peer $peerID")
    }
     ...
     */
    private fun establishNoiseSessionIfNeeded(peerID: String, meshService: com.wichat.android.wifi.WifiMeshService) {
     ...
     */
    private fun establishNoiseSessionIfNeededLegacy(peerID: String, meshService: com.wichat.android.wifi.WifiMeshService) {
        try {
     ...
     */
    private fun initiateHandshakeWithPeer(peerID: String, meshService: com.wichat.android.wifi.WifiMeshService) {
        try {
     ...
     */
    private fun sendNoiseIdentityAnnouncement(meshService: com.wichat.android.wifi.WifiMeshService) {
        try {
    ...
    private fun getPeerIDForNickname(nickname: String, meshService: com.wichat.android.wifi.WifiMeshService): String? {
    ...
    private fun getPeerNickname(peerID: String, meshService: com.wichat.android.wifi.WifiMeshService): String {
