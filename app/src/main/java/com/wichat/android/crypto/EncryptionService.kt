package com.wichat.android.crypto

import android.content.Context
import android.util.Log
import com.wichat.android.noise.NoiseEncryptionService
...
class EncryptionService(private val context: Context) {
    ...
    /**
     * Save encryption sessions for persistence across app lifecycle
     */
    fun saveSessions() {
        noiseService.saveSessions()
    }
    
    /**
     * Restore encryption sessions from persistence
     */
    fun restoreSessions() {
        noiseService.restoreSessions()
    }
    
    /**
     * Auto-establish sessions with known peers
     */
    fun autoEstablishKnownPeerSessions(availablePeers: Set<String>) {
        noiseService.autoEstablishKnownPeerSessions(availablePeers)
    }
