package com.wichat.android.protocol
...
enum class MessageType(val value: UByte) {
    ...
    // Voice call messages
    VOICE_CALL_OFFER(0x30u),            // Initiate voice call
    VOICE_CALL_ANSWER(0x31u),           // Accept voice call
    VOICE_CALL_HANGUP(0x32u),           // End voice call
    VOICE_AUDIO_DATA(0x33u),            // Voice audio packet
    VOICE_CALL_REJECT(0x34u),           // Reject voice call
